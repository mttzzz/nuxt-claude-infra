...
export function buildMcpServerEnv(options) {
...
if (isMainModule(import.meta)) {
    ...
    if (!sessionId) {
        process.stderr.write('[mcp:server] sessionId не определён: нет CLAUDE_SESSION_ID, и harness-pid не нашёл pointer ' +
